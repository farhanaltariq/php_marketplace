        ...
        <div class="signupform">
            ...
            <form method="post">
                <div class="left-form mb-3">
                    ...
                    <input name="birthday" placeholder="Birthday" type="text" class="form-control field" id="exampleInputEmail1"">
                </div>
                <div class="right-form mb-3">
                    ...
                    <input name="gender" placeholder="Gender" type="text" class="form-control field" id="exampleInputEmail1"">
